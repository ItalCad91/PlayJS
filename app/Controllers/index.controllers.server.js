...
{
    res.render('index', {title : 'PlayJS Guess Number', page:'listofgames/guess'}); // RENDERS IN THE EJS TEMPLATE CALLED INDEX
};

export function displayGame2Page(req, res, next) 
{
    res.render('index', {title : 'PlayJS Pig Game', page:'listofgames/pig'}); // RENDERS IN THE EJS TEMPLATE CALLED INDEX
};
